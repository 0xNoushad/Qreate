                    ...
                    <div className="aboutttt__container container">
                        <div className="about__content" style={{marginTop: language === "de" ? "10rem" : language === "fr" ? "7rem" : language === "ar" ? "-15rem" : ""}}>
                            ...
                            <div className="about__quote">
                                ...
                                <motion.h3 initial={{ x: -50 }} whileInView={{ x: 0 }} transition={{ staggerChildren: 3.5, duration: 0.7, ease: [0.42, 0, 0.58, 1] }}>“It Is What It Is.”</motion.h3>
            ...
            <div className="about__bottom container">
                ...
                <motion.div className="about__bottom_container" initial={{ x: 50 }} whileInView={{ x: 0 }} transition={{ staggerChildren: 3.5, duration: 0.7, ease: [0.42, 0, 0.58, 1] }}>
                    <div className="exp_desc">
                        <h3>- We HAve never ran out of ideas</h3>
                        <h3>-  Been develop</h3>
                    </div>
                </motion.div>
                ...
                <div className="kudos_desc">
                    ...
                    <motion.img className='bottom_img' width="100%"  title='Showing something' height="100%" loading='eager' src={require("../../../../assets/profile2.JPG")} alt="Showing Something" initial={{ y: 50 }} whileInView={{ y: 0 }} transition={{ staggerChildren: 3.5, duration: 0.7, ease: [0.42, 0, 0.58, 1] }} />
                </div>
            </div>
        </motion.div>
    )
