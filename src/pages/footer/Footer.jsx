      ...
      {isMobile ? (
        <div className="footer__container container">
          ...
          <div className="footer__social">
            ...
            <div className="footer__socials">
              <a href="#" className="footer__social-link" target='_blank' rel="noreferrer"><i className="uil uil-instagram"></i></a>
              <a href="#" className="footer__social-link" target='_blank' rel="noreferrer"><BiLogoFacebookCircle /></a>
              <a href="#" className="footer__social-link" target='_blank' rel="noreferrer"><BiLogoTwitter /></a>
              <a href="#" className="footer__social-link" target='_blank' rel="noreferrer"><BiLogoLinkedin /></a>
              <a href="#" className="footer__social-link" target='_blank' rel="noreferrer"><BiLogoGithub /></a>

            </div>
          </div>
          <div className="footer__copyright">
            <small>&copy; Qreate Studio. {t("footer__credits")}</small>
          </div>
        </div>
      ) : (
        <motion.div className="footer__container container"  >
          ...
          <div className="footer__social">
            ...
            <div className="footer__socials">
              <a href="#" className="footer__social-link" target='_blank' rel="noreferrer"><BiLogoInstagram /></a>
              <a href="#" className="footer__social-link" target='_blank' rel="noreferrer"><BiLogoFacebookCircle/></a>
              <a href="#" className="footer__social-link" target='_blank' rel="noreferrer"><BiLogoTwitter /></a>
              <a href="#" className="footer__social-link" target='_blank' rel="noreferrer"><BiLogoLinkedin /></a>
              <a href="#" className="footer__social-link" target='_blank' rel="noreferrer"><BiLogoGithub /></a>
